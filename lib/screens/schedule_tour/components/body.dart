...
import 'package:flutter_travelapp/components/TextFrave.dart';
import 'package:flutter_travelapp/components/painter.dart';
import 'package:flutter_travelapp/models/armchairs_model.dart';
import 'package:flutter_travelapp/models/datetime_model.dart';
import 'package:flutter_travelapp/screens/schedule_tour/Bloc/cinema/cinema_bloc.dart';
import 'package:flutter_travelapp/screens/schedule_tour/components/seats.dart';
          ...
          Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(
                fit: BoxFit.cover,
                image: AssetImage(widget.imageTour)
              )
            ),
            child: Container(
              decoration: BoxDecoration(
              ...
              child: IconButton(
                ...
                icon: Row(
                  children: [
                    ...
                    SizedBox(width: 20.0),
                    TextFrave(text: widget.titleTour, color: Colors.white, fontWeight: FontWeight.bold )
                  ],
                )
              ),
            )
      ...
      child: InkWell(
        ...
        //   builder: (context, state) => 
            Container(
              ...
              decoration: BoxDecoration(
                color: time == time ? Colors.amber : Color(0xff4D525A),
                borderRadius: BorderRadius.circular(8.0)
              ),
